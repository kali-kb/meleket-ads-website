...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "5cb1974c-f6de-41c9-be11-3add62ad58e4",
  ...
  "public": {},
  "databaseUrl": "postgresql://vn618f:xau_u8WDxwHEyrklMr5acxgLdXuw9iiaXaTj2@us-east-1.sql.xata.sh/meleket-ads:main?sslmode=require"
};
const envOptions = {
  prefix: "NITRO_",
...
const _lazy_t_r9LM = () => import('../routes/api/contact.post.mjs');
const _lazy_zV8bXm = () => import('../routes/api/contacts.get.mjs');
const _lazy_eRWYsr = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/contact', handler: _lazy_t_r9LM, lazy: true, middleware: false, method: "post" },
  { route: '/api/contacts', handler: _lazy_zV8bXm, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_eRWYsr, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_eRWYsr, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, defu as A, parseQuery as B, withTrailingSlash as C, withoutTrailingSlash as D, normalizeCookieHeader as a, normalizeLambdaOutgoingBody as b, normalizeLambdaOutgoingHeaders as c, defineEventHandler as d, createError$1 as e, getQuery as f, getRouteRulesForPath as g, useRuntimeConfig as h, getResponseStatusText as i, joinRelativeURL as j, getResponseStatus as k, defineRenderHandler as l, getRouteRules as m, normalizeLambdaIncomingHeaders as n, hasProtocol as o, isScriptProtocol as p, joinURL as q, readBody as r, sanitizeStatusCode as s, getContext as t, useNitroApp as u, createHooks as v, withQuery as w, executeAsync as x, toRouteMatcher as y, createRouter$1 as z };
